            ...
            >
                <div
                    className={cn(
                        ...
                        "bg-gradient-to-r to-white/0 dark:to-transparent",
                        gradient,
                        "backdrop-blur-[2px] border-2",
                        "border-black/[0.1] dark:border-white/[0.15]",
                        "shadow-[0_8px_32px_0_rgba(0,0,0,0.1)] dark:shadow-[0_8px_32px_0_rgba(255,255,255,0.1)]",
                        "after:absolute after:inset-0 after:rounded-full",
                        "after:bg-[radial-gradient(circle_at_50%_50%,rgba(255,255,255,0.2),transparent_70%)] dark:after:bg-[radial-gradient(circle_at_50%_50%,rgba(255,255,255,0.2),transparent_70%)]"
                    )}
                />
            </motion.div>
        </motion.div>
...
export function HeroGeometric({
    ...
    return (
        <div className="relative min-h-[90vh] w-full flex items-center justify-center overflow-hidden bg-transparent transition-colors duration-300">
            <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/[0.05] via-white/0 to-rose-500/[0.05] dark:via-black/0 blur-3xl" />
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-white via-white/0 to-white/0 pointer-events-none dark:from-black dark:via-black/0 dark:to-black/0" />
